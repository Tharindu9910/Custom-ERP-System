...
const USERS = [
  { username: 'superadmin',  password: 'Super@123',   full_name: 'Super Admin',    role: 'SUPER_ADMIN', branch_id: null },
  { username: 'manager1',    password: 'Manager@123', full_name: 'Branch Manager', role: 'MANAGER',     branch_id: null },
  { username: 'admin1',      password: 'Admin@123',   full_name: 'Branch Admin',   role: 'ADMIN',       branch_id: PLACEHOLDER_BRANCH },
  { username: 'supervisor1', password: 'Super1@123',  full_name: 'Supervisor One', role: 'SUPERVISOR',  branch_id: PLACEHOLDER_BRANCH },
  { username: 'cashier1',    password: 'Cashier@123', full_name: 'Cashier One',    role: 'CASHIER',     branch_id: PLACEHOLDER_BRANCH },
]
...
async function seed() {
  ...
  try {
    ...
    console.error('❌ Constraint NOT enforced — duplicate active role was inserted!')
    process.exit(1)
  } catch {
    console.log('   ✅ Constraint enforced — duplicate insert correctly rejected')
  }
